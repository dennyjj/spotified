  ...
  return (
    <AppBar position="sticky">
      <Toolbar sx={{ justifyContent: 'space-around' }}>
        ...
        {isLoginPage ? <FlexGrowBox flexGrow={1} /> : <AppBarLinkButton href="/artists/medium-term" title="Top Artists" />}
        {isLoginPage ? <FlexGrowBox flexGrow={1} /> : <AppBarLinkButton href="/tracks/medium-term" title="Top Tracks" />}
